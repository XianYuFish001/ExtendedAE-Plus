...
item_ids:
  - extendedae_plus:provider_controller
---

# Provider Controller

<ItemImage id="extendedae_plus:provider_controller" scale="5" />

The **Provider Controller** is a central control unit that allows you to manage the working modes of all pattern providers in your network through a single unified interface.
...
## How to Use
1. Place the **Provider Controller** in your ME network.
