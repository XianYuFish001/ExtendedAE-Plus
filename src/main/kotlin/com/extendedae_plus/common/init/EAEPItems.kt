...
object EAEPItems {
    ...
    /** CraftingUnit Items are now in [com.extendedae_plus.common.registry.block.EAEPCraftingUnit.Items] */
    val Items = ArrayList<DeferredItem<*>>()

    @JvmField
    val WirelessTransceiver = this.regCommonBlockItem(EAEPBlocks.WirelessTransceiver)
    @JvmField
    val PortUpload = this.regCommonBlockItem(EAEPBlocks.PortUpload)
    @JvmField
    val CoreAdvancedCrafter = this.regCommonBlockItem(EAEPBlocks.CoreAdvancedCrafter)
    @JvmField
    val CoreAdvancedPattern = this.regCommonBlockItem(EAEPBlocks.CoreAdvancedPattern)
    @JvmField
    val CoreAdvancedSpeed = this.regCommonBlockItem(EAEPBlocks.CoreAdvancedSpeed)
