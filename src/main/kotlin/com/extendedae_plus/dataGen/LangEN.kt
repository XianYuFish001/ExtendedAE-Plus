...
class LangEN(output: PackOutput) : LanguageProvider(output, ExtendedAEPlus.MODID, "en_us") {
    override fun addTranslations() {
        ...
        UtilKeyBuilder.dataGen(Patterns.Message)
            ...
            .branch("global_switch", "[EAEP] The global setting is now in effect, affecting PatternProvider x%s")
            .addStr("cui")
            .snapshot()
            .addStr("title")
            .branch("tip", "Now we have CUI")
            .buildInto("========%s========")
            .restore()
            .addStr("button")
            .snapshot()
            .addStr("blocking")
            .branch("normal", "[Toggle Normal Blocking]")
            .branch("smart", "[Toggle Smart Blocking]")
            .restore()
            .branch("doubling", "[Toggle Smart Doubling]")
            .addStr("of_all")
            .branch("on", "[Open All]")
            .branch("off", "[Close All]")
        UtilKeyBuilder.dataGen(Patterns.Message)
