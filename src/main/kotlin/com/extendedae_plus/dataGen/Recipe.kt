...
import com.extendedae_plus.util.extension.input
...
class Recipe(
    ...
    override fun buildRecipes(recipeOutput: RecipeOutput) {
        ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, EAEPItems.CardChannel)
            ...
            .save(recipeOutput)
        ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, EAEPItems.ControllerProvider)
            .requires(AEItems.NETWORK_TOOL)
            .requires(EAETags.EX_PATTERN_PROVIDER)
            .unlockedBy("has_provider", has(EAETags.EX_PATTERN_PROVIDER))
            .save(recipeOutput)
        ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, EAEPCraftingUnit.ACCELERATOR_4x.block)
            ...
            .save(recipeOutput)
        ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, EAEPCraftingUnit.ACCELERATOR_16x.block)
            .requires(AEBlocks.CRAFTING_ACCELERATOR)
            .requires(AEItems.CELL_COMPONENT_16K)
            .unlockedBy("has_accelerator", has(AEBlocks.CRAFTING_ACCELERATOR))
            .save(recipeOutput)
        ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, EAEPCraftingUnit.ACCELERATOR_64x.block)
            .requires(AEBlocks.CRAFTING_ACCELERATOR)
            .requires(AEItems.CELL_COMPONENT_64K)
            .unlockedBy("has_accelerator", has(AEBlocks.CRAFTING_ACCELERATOR))
            .save(recipeOutput)
        ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, EAEPCraftingUnit.ACCELERATOR_256x.block)
            .requires(AEBlocks.CRAFTING_ACCELERATOR)
            .requires(AEItems.CELL_COMPONENT_256K)
            .unlockedBy("has_accelerator", has(AEBlocks.CRAFTING_ACCELERATOR))
            .save(recipeOutput)
        ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, EAEPCraftingUnit.ACCELERATOR_1024x.block)
            .requires(AEBlocks.CRAFTING_ACCELERATOR)
            .requires(AEItems.CELL_COMPONENT_256K, 2)
            .unlockedBy("has_accelerator", has(AEBlocks.CRAFTING_ACCELERATOR))
            .save(recipeOutput)
        ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, EAEPItems.CardAutoCompletion)
            .requires(AEItems.ADVANCED_CARD)
            .requires(Items.CRAFTER)
            .unlockedBy("has_card", has(AEItems.ADVANCED_CARD))
            .save(recipeOutput)
        ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, EAEPItems.PriorityTool)
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, DataTickingCard.toStack(2, 16))
            ...
            .save(recipeOutput, getLocation("entity_speed_card_2x"))
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, DataTickingCard.toStack(4, 192))
            ...
            .define('d', AEItems.SINGULARITY)
            .unlockedBy("has_card", has(AEItems.SPEED_CARD))
            .save(recipeOutput, getLocation("entity_speed_card_4x"))
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, DataTickingCard.toStack(8, 512))
            ...
            .define('d', AEItems.SINGULARITY)
            .unlockedBy("has_card", has(AEItems.SPEED_CARD))
            .save(recipeOutput, getLocation("entity_speed_card_8x"))
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, DataTickingCard.toStack(16, 1024))
            ...
            .unlockedBy("has_card", has(AEItems.SPEED_CARD))
            .save(recipeOutput, getLocation("entity_speed_card_16x"))
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, EAEPItems.Ticker)
            .pattern("ses")
            .pattern("apf")
            .pattern("ses")
            ...
            .save(recipeOutput)
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, EAEPItems.WirelessTransceiver)
            .pattern(" r ")
            .pattern("rlr")
            .pattern(" r ")
        ...
        CrystalAssemblerRecipeBuilder.assemble(EAEPItems.PortUpload)
            .input(EAESingletons.ASSEMBLER_MATRIX_WALL)
            .input(EAEPItems.WirelessTransceiver)
            .input(AEItems.COLORED_LUMEN_PAINT_BALL.item(AEColor.LIME), 6)
            .input(AEItems.CALCULATION_PROCESSOR)
            .save(recipeOutput, getLocation("assembler/assembler_matrix_upload"))
        CrystalAssemblerRecipeBuilder.assemble(EAEPItems.CellInfinity)
            ...
            .save(recipeOutput, getLocation("assembler/infinity_cell_item"))
        CrystalAssemblerRecipeBuilder.assemble(EAEPItems.CoreAdvancedCrafter)
            ...
            .save(recipeOutput, getLocation("assembler/core_advanced_crafter"))
        CrystalAssemblerRecipeBuilder.assemble(EAEPItems.CoreAdvancedPattern)
            ...
            .save(recipeOutput, getLocation("assembler/core_advanced_pattern"))
        CrystalAssemblerRecipeBuilder.assemble(EAEPItems.CoreAdvancedSpeed)
            ...
            .save(recipeOutput, getLocation("assembler/core_advanced_speed"))
    }
}
