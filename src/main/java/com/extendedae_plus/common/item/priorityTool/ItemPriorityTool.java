package com.extendedae_plus.common.item.priorityTool;
...
public class ItemPriorityTool extends AEBaseItem implements IMenuItem {
    ...
    public InteractionResult onItemUseFirst(ItemStack stack, UseOnContext context) {
        ...
        if (data == null) {
            MenuOpener.open(ModMenuTypes.PRIORITY_TOOL.get(), player,
    ...
    public InteractionResultHolder<ItemStack> use(Level level, Player player, InteractionHand usedHand) {
        ...
        if (!MenuOpener.open(ModMenuTypes.PRIORITY_TOOL.get(), player, MenuLocators.forHand(player, usedHand)))
